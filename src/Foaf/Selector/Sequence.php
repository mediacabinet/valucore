...
use Foaf\Selector\SimpleSelector\Universal,
    Foaf\Selector\SimpleSelector\Element,
    Foaf\Selector\SimpleSelector;
...
class Sequence implements \Iterator
{
     ...
     * @return Sequence
     */
    public function appendSimpleSelector(SimpleSelector $simpleSelector){
        ...
        if( !sizeof($this->items) && 
            ...
            $this->appendSimpleSelector($universal);
        }
        */
        ...
        if( sizeof($this->items) && 
            ...
            throw new \InvalidArgumentException('Universal and Element selectors must appear first in the sequence');
        }
