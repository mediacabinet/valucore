...
class Configurator implements ConfiguratorInterface
{
     ...
     * Delegate manager
     *
     * @var \Valu\InputFilter\Configurator\DelegateManager
     */
    private $plugins;
     ...
     * Add new delegate
     *
     * @param string|\Valu\InputFilter\Configurator\Delegate\DelegateInterface $delegate            
     * @param string $name
     *            Input filter name
     ...
     * plugin manager.
     *
     * @return \Valu\InputFilter\Configurator\DelegateManager
     */
